...
namespace Rendering.Scenes
{
    public static class CornellBox
    {
        public static Scene CreateScene()
        {
            ...
            Func<Point, UnitVector, Material, Volume> plane = (Point p, UnitVector v, Material m) => new InfinitePlane(m, p, v);
            Func<Point, double, Material, Volume> sphere = (Point p, double r, Material m) => new Sphere(m, p, r);
